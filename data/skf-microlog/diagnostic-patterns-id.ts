...
export const QUICK_DIAGNOSIS_ID: { signature: string; suspect: string }[] = [
  { signature: "1× radial dominan, fase stabil", suspect: "UNBALANCE" },
  { signature: "1× radial + aksial, fase OB≠IB", suspect: "MISALIGNMENT" },
  { signature: "Banyak harmonik + lantai derau naik", suspect: "KELONGGARAN Tipe C" },
  { signature: "Puncak 0.4–0.48× RPM", suspect: "OIL WHIRL" },
  { signature: "2× jala-jala (120 Hz) + sideband Fp", suspect: "EKSENTRISITAS ROTOR" },
  { signature: "2× jala-jala terarah (tanpa Fp)", suspect: "EKSENTRISITAS STATOR" },
  { signature: "BPFI / BPFO / BSF / FTF + harmonik", suspect: "BEARING Tahap 3+" },
  { signature: "Hanya gE ultrasonik / HFD yang naik", suspect: "BEARING Tahap 1–2" },
  { signature: "GMF + banyak sideband pada 1× gear", suspect: "KEAUSAN GIGI" },
  { signature: "2GMF / 3GMF > 1GMF", suspect: "MISKONFIGURASI GIGI" },
  { signature: "Lonjakan tajam di time waveform per rev", suspect: "GIGI RETAK/PATAH" },
  { signature: "Broadband acak frekuensi tinggi + BPF", suspect: "KAVITASI" },
  { signature: "2× frekuensi sabuk berdenyut", suspect: "SABUK AUS/LONGGAR" },
  { signature: "Amplitudo keseluruhan berdenyut (beat)", suspect: "GETARAN BEAT" }
];
