...
export const T = {
  en: {
    ...
    home: {
      ...
      calcs: {
        ...
        convert: {
          ...
          desc: "Quickly convert standard electrical and dimensional units.",
        },
        tutorials: {
    ...
    convert: {
      title: "Electrical Converter",
      subtitle: "Quick conversions for field engineering",
      concept: "Convert standard electrical units like **kW to HP**, **kVA to Amps**, and physical dimensions like **AWG to mm²** and **Meters to Inches**.",
  ...
  id: {
    ...
    home: {
      ...
      calcs: {
        ...
        convert: {
          title: "Konverter Elektrikal",
          desc: "Konversi cepat satuan listrik dan dimensi standar teknis.",
        },
        tutorials: {
    ...
    convert: {
      ...
      concept: "Konversi unit listrik standar seperti **kW ke HP**, **kVA ke Amps**, dan dimensi fisik seperti **AWG ke mm²** dan **Meter ke Inci**.",
      motorKw: "kW", motorHp: "HP", panelMm: "mm", panelInch: "inch",
      cableAwg: "AWG", cableMm2: "mm²",
      kva: "kVA", amps: "Amps",
      secMotor: "Daya Motor (Sudut Pandang: Nameplate Motor)",
      secPanel: "Dimensi Enclosure (Sudut Pandang: Panel Builder)",
      secCable: "Ukuran Konduktor (Sudut Pandang: Pengkabelan)",
      secPower: "Daya Semu (Sudut Pandang: Trafo/Genset)",
      distMeter: "Meter (m)", distInch: "Inci (in)", secDist: "Jarak Tarik Kabel (Sudut Pandang: Jalur Kabel)",
    },
    pid: {
